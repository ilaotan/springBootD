...
import com.springBootD.framework.config.shiro.ShiroDbRealm;
...
public class ShiroConfig {
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "springBootD", name = "spring-session-open", havingValue = "true")
     ...
     */
    @Bean
    public CacheManager getCacheShiroManager(@Qualifier("cacheManagerFactory") EhCacheManagerFactoryBean ehcache) {
